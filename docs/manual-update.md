...
打开 [https://github.com/liwusen/FaustBot-llm-vtuber/releases/latest](https://github.com/liwusen/FaustBot-llm-vtuber/releases/latest)

下载 最新的`faust-V<版本号>-without-runtime.zip`,注意:一定是带without-runtime后缀的版本!
